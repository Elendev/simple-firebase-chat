...
exports.default = {
    ...
    methods: {
        ...
        joinChatroom: function joinChatroom(event) {
            var chatroomName = prompt('Chatroom Name');

            firebase.database().ref('/chatroom-list/' + this.user.uid + '/' + chatroomName).set(true).then(function (result) {
                alert('Chatroom correctly added !');
            }, function (error) {
                alert('Impossible to add chatroom "' + chatroomName + '", please try with an other name');
            });
        },
        selectChatroom: function selectChatroom(chatroomId) {
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7cc87654", __vue__options__)
  } else {
...
var _Chatroom = require('./chatroom/Chatroom.vue');

var _Chatroom2 = _interopRequireDefault(_Chatroom);

var _ChatroomList = require('./chatroom/ChatroomList.vue');

var _ChatroomList2 = _interopRequireDefault(_ChatroomList);
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4dc6dd6f", __vue__options__)
  } else {
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b541a0a6", __vue__options__)
  } else {
